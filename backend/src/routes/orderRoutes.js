...
import { createOrderSchema, addItemsSchema, createTakeAwayOrderSchema, sendKotOrderSchema } from '../validators/orderValidator.js';
...
router.post('/send-kot', requirePermission('ORDER_CREATE'), validate(sendKotOrderSchema), orderController.sendKotOrder);
